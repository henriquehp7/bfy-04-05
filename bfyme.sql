...
INSERT INTO `t_sbfy_categoria` (`cd_categoria`, `nm_categoria`) VALUES
(3, 'CABELO'),
(6, 'ESTÉTICA CORPORAL'),
(7, 'ESTÉTICA FACIAL'),
(1, 'MAQUIAGEM'),
...
INSERT INTO `t_sbfy_servico` (`cd_servico`, `cd_categoria`, `nm_servico`, `ds_servico`, `nr_duracao_maxima_servico`, `vl_servico`) VALUES
...
INSERT INTO `t_sbfy_usuario` (`cd_usuario`, `nm_cliente`, `nm_usuario`, `ds_email`, `nr_cpf`, `dt_nascimento`, `ds_senha`, `ds_sexo`) VALUES
...
ALTER TABLE `t_sbfy_categoria`
  ...
  ADD UNIQUE KEY `UN_SBFY_CATEGORIA` (`nm_categoria`);
...
ALTER TABLE `t_sbfy_usuario`
  ...
  ADD UNIQUE KEY `UN_SBFY_EMAIL` (`ds_email`),
  ADD UNIQUE KEY `UN_SBFY_CPF` (`nr_cpf`),
  ADD UNIQUE KEY `UN_SBFY_NMUSUARIO` (`nm_usuario`);
...
--
ALTER TABLE `t_sbfy_categoria`
  MODIFY `cd_categoria` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `t_sbfy_servico`
--
ALTER TABLE `t_sbfy_servico`
  MODIFY `cd_servico` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
