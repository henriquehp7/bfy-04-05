    ...
    <div class="foo">
      ...
      <div class="container">
        <div class="modal-login">
          ...
          <form class="modal-form register-form" action="cadastro.php" method="post">
            ...
            <fieldset class="register-field">
              ...
              <input class="login-input" type="text" name="usuarioCadastro" id="usuarioCadastro" placeholder="Digite um nome de usuário" required>
            </fieldset>
            <fieldset class="register-field">
            ...
            <button class="btn" type="submit" name="enviar">Salvar meus dados</button>
          </form>
        </div>
